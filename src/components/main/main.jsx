...
const Main = (props) => {
  ...
  const offersList = offers.map((offer, i) => <Apartment key={offer + i} offer={offer} onHeaderButtonClick={onHeaderButtonClick}/>);
        ...
        <div className="cities">
          <div className="cities__places-container container">
            <section className="cities__places places">
              ...
              <div className="cities__places-list places__list tabs__content">{offersList}
              </div>
            </section>
